...
W2 = tf.get_variable("W2", shape=[nb_classes,nb_classes], initializer=tf.contrib.layers.xavier_initializer())
...
W5 = tf.get_variable("W5", shape=[nb_classes, 10], initializer=tf.contrib.layers.xavier_initializer())
